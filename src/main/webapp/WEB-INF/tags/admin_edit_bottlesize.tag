...
<div id="admin_bottle_table">
    <table class="table table-striped">
        ...
        <c:forEach items="${bottleSizes}" var="bottle" varStatus="i">
            <form:form method="post" action="change_bottle" modelAttribute="bottleModel">
                <tr bgcolor="white">
                    <td>${i.count}</td>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form:form id="create-user-form" class="createForm" method="post" action="create_size" modelAttribute="sizeModel">
